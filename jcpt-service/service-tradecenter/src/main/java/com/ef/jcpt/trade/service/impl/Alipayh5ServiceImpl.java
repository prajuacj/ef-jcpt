...
import com.ef.jcpt.trade.service.IAlipayh5Service;
import com.ef.jcpt.trade.service.bo.Alipayh5Bo;
import com.payment.core.ComContents;
import com.payment.core.alipay.h5.config.AlipayConfig;
import com.payment.core.alipay.h5.config.Alipayh5Contents;
import com.payment.core.alipay.h5.sign.RSA;
import com.payment.core.alipay.h5.util.AlipayNotify;
import com.payment.core.alipay.h5.util.AlipaySubmit;
...
public class Alipayh5ServiceImpl implements IAlipayh5Service {
	...
	public String toPay(Alipayh5Bo bo) {
		...
		// //////////////////////////////////请求参数//////////////////////////////////////
				...
				// 必填，不能修改
				// 服务器异步通知页面路径
				String notify_url = ComContents.payserviceurl + Alipayh5Contents.alipayh5backUrl;
				// 需http://格式的完整路径，不能加?id=123这类自定义参数
				// 页面跳转同步通知页面路径
				String return_url = ComContents.payserviceurl + Alipayh5Contents.alipayh5frontUrl;
				...
				//获取各个系统的返回URL前缀
				String osprefix = Alipayh5Contents.getOsBackUrl(payCommon.getOs());
				String show_url = osprefix + payCommon.getBackUrl();
...
//				}
				...
				sParaTemp.put("service", "alipay.wap.create.direct.pay.by.user");//alipay.trade.wap.pay
	...
	public String buildMobilePayData(Alipayh5Bo bo) throws Exception {
		...
		// TODO Auto-generated method stub
				// //////////////////////////////////请求参数//////////////////////////////////////
						...
						// 商品展示地址
						//String show_url = ComContents.payserviceurl+"/m/goods/goodsdetail?id=34";
						String show_url = ComContents.payserviceurl+payCommon.getBackUrl();
						// 必填，需以http://开头的完整路径，例如：http://www.商户网址.com/myorder.html
						// 订单描述
						String body = "无描述";
...
//						}
						...
						// 把请求参数打包成数组
						Map<String, String> sParaTemp = new HashMap<String, String>();
						sParaTemp.put("service", "mobile.securitypay.pay");//alipay.trade.wap.pay
						sParaTemp.put("partner", AlipayConfig.partner);
						sParaTemp.put("seller_id", AlipayConfig.seller_id);
						sParaTemp.put("_input_charset", AlipayConfig.input_charset);
						sParaTemp.put("payment_type", payment_type);
						...
						// 建立请求
					    String sign = RSA.sign(sHtmlText, AlipayConfig.private_key, AlipayConfig.input_charset);
