package com.ef.jcpt.wi.manage.app;
...
public class ManageWiStartApplication {

	private static final Logger logger = LoggerFactory.getLogger(ManageWiStartApplication.class);

	private static volatile boolean running = true;

	public static void main(String[] args) {

		Class<?> clazz = ManageWiStartApplication.class;
		try {
