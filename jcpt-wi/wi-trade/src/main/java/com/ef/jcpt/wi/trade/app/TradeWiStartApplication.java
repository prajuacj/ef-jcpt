package com.ef.jcpt.wi.trade.app;
...
public class TradeWiStartApplication {

	private static final Logger logger = LoggerFactory.getLogger(TradeWiStartApplication.class);
	private static volatile boolean running = true;

	public static void main(String[] args) {

		Class<?> clazz = TradeWiStartApplication.class;
		try {
